...
},{}],"src/ComputerPaddle.ts":[function(require,module,exports) {
"use strict";
...
function () {
  function Game() {
    ...
    var paddleWidth = 20,
        ...
        ballSize = 10,
        wallOffset = 20;
    this.player1 = new Paddle_1.Paddle(paddleWidth, paddleHeight, wallOffset, this.gameCanvas.height / 2 - paddleHeight / 2);
    this.computerPlayer = new ComputerPaddle_1.ComputerPaddle(paddleWidth, paddleHeight, this.gameCanvas.width - (wallOffset + paddleWidth), this.gameCanvas.height / 2 - paddleHeight / 2);
  ...
  Game.prototype.drawBoardDetails = function () {
    ...
    this.gameContext.strokeRect(10, 10, this.gameCanvas.width - 20, this.gameCanvas.height - 20); //draw center lines
...
exports.Game = Game;
},{"./Paddle":"src/Paddle.ts","./ComputerPaddle":"src/ComputerPaddle.ts","./Ball":"src/Ball.ts"}],"src/Controls.ts":[function(require,module,exports) {
"use strict";
...
function (_super) {
  ...
  Paddle.prototype.update = function (canvas) {
    if (Game_1.Game.keysPressed[Controls_1.KeyBindings.UP]) {
      this.yVel = -1;

      if (this.y <= 20) {
        this.yVel = 0;
      }
    } else if (Game_1.Game.keysPressed[Controls_1.KeyBindings.DOWN]) {
      this.yVel = 1;
...
},{"./Entity":"src/Entity.ts","./Game":"src/Game.ts","./Controls":"src/Controls.ts"}],"src/game.ts":[function(require,module,exports) {
"use strict";
...
exports.Game = Game;
},{"./Paddle":"src/Paddle.ts","./ComputerPaddle":"src/ComputerPaddle.ts","./Ball":"src/Ball.ts"}],"../../../../.nvm/versions/node/v14.17.3/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../.nvm/versions/node/v14.17.3/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/game.ts"], null)
